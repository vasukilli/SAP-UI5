		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#test5cssstylesoncustomcontrols-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"test5cssstylesoncustomcontrols-display": {
								"semanticObject": "test5cssstylesoncustomcontrols",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test5cssstylesoncustomcontrols",
									"url": sap.ui.require.toUrl("test5cssstylesoncustomcontrols")
								}
							}
						}
					}
