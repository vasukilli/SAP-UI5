		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SampleApplication2",
									"targetURL": "#srvnorthwindproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"srvnorthwindproject2-display": {
								"semanticObject": "srvnorthwindproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=srv.northwind.project2",
									"url": sap.ui.require.toUrl("srv/northwind/project2")
								}
							}
						}
					}
