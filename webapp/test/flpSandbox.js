		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#test83dpyramidcss090224-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"test83dpyramidcss090224-display": {
								"semanticObject": "test83dpyramidcss090224",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test83dpyramidcss090224",
									"url": sap.ui.require.toUrl("test83dpyramidcss090224")
								}
							}
						}
					}
