		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#test6stylesincontrol080224-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"test6stylesincontrol080224-display": {
								"semanticObject": "test6stylesincontrol080224",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test6stylesincontrol080224",
									"url": sap.ui.require.toUrl("test6stylesincontrol080224")
								}
							}
						}
					}
