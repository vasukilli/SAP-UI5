		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#test4customcontrol010224-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"test4customcontrol010224-display": {
								"semanticObject": "test4customcontrol010224",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test4customcontrol010224",
									"url": sap.ui.require.toUrl("test4customcontrol010224")
								}
							}
						}
					}
